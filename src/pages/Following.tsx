    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        {isDemoMode() ? (
          ...
          <EmptyState icon={Bell} title="No new activity yet" description={`You're following ${data.watchedProperties.length} propert${data.watchedProperties.length === 1 ? 'y' : 'ies'}. New reviews and score changes will appear here.`} primary={{ label: 'Add your truth', to: '/contribute' }} />
        ) : (
